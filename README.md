...
未登入 Bilibili 帳號的情況下，官方僅允許讀取兩條回覆<br />本腳本可以取消限制，讓您**無須登入**即可正常閱讀、排序與瀏覽所有留言及子評論！<br />透過官方公開 API 與 WBI 簽名機制，**自動還原原生風格的評論區**

[核心特色](#核心特色) · [支援頁面](#支援頁面) · [安裝方式](#安裝方式) · [自訂設定](#設定與自訂) · [常見問題](#常見問題) · [系統架構](#系統架構) · [致謝與宣告](#致謝與宣告)
...
- 👉 **[從 Greasy Fork 安裝](https://update.greasyfork.org/scripts/595475/Bilibili%20%E5%85%8D%E7%99%BB%E5%85%A5%E9%A1%AF%E7%A4%BA%E7%95%99%E8%A8%80.user.js)**
...
| 設定項 | 預設值 | 說明 | 生效時機 |
| :--- | :---: | :--- | :--- |
| **使用分頁加載主評論** | 關閉 | 開啟後主評論將改用數字分頁切換，關閉則為無限滾動加載 | 重新整理頁面後 |
| **一次性加載所有子評論** | 關閉 | 展開二級回覆時是否一次性輪詢拉取全部評論 | 重新整理頁面後 |
| **顯示用戶頭像邊框** | 開啟 | 顯示用戶客製化裝扮頭像框 | 即時生效 |
| **顯示粉絲勳章** | 開啟 | 顯示用戶佩戴的實況主粉絲徽章及等級 | 即時生效 |
| **顯示右上角大航海裝飾** | 開啟 | 顯示艦長、提督、總督專屬身份卡片 | 即時生效 |
| **顯示「筆記」前綴** | 開啟 | 標記發布圖文筆記的標籤 | 即時生效 |
| **顯示「熱評」標籤** | 開啟 | 標記熱門回覆標籤 | 即時生效 |
| **顯示「UP主覺得很贊」標籤**| 開啟 | 標記獲得創作者按讚之標籤 | 即時生效 |
| **顯示大會員用戶名為粉色** | 開啟 | 還原大會員專屬粉色暱稱外觀 | 即時生效 |
| **啟用關鍵字搜尋連結** | 開啟 | 解析留言內提及的關鍵字與熱搜搜尋跳轉點 | 重新整理頁面後 |

---

## ⚠️ 常見問題與注意事項

1. **為什麼看到「UP主已關閉評論區」或「無法從 API 獲取評論」？**
   * 部分稿件創作者主動關閉了評論互動功能；或遇 Bilibili 官方 API 網路波動，請嘗試重新整理頁面
2. **已登入帳號會受影響嗎？**
   * 不會。腳本具備登入偵測機制，若已登入將完全交由 B 站官方原生腳本接管
3. **遇到 Bug 或頁面無法加載怎麼辦？**
   * 請前往 [GreasyFork 反饋區](https://greasyfork.org/zh-TW/scripts/595475-bilibili-%E5%85%8D%E7%99%BB%E5%85%A5%E9%A1%AF%E7%A4%BA%E7%95%99%E8%A8%80/feedback) 或 [GitHub Issues](https://github.com/pthuang01/bilibili-login-free-comments/issues) 提交反饋，並附上出問題的**影片網址**與**瀏覽器主控台（F12 Console）錯誤截圖**
---
...
- Author: **DoReMi ([@pthuang01](https://github.com/pthuang01))**
- Original Author: 感謝原作者 **[DD1969](https://greasyfork.org/zh-TW/scripts/473498-bilibili-%E5%9C%A8%E6%9C%AA%E7%99%BB%E5%BD%95%E7%9A%84%E6%83%85%E5%86%B5%E4%B8%8B%E7%85%A7%E5%B8%B8%E5%8A%A0%E8%BD%BD%E8%AF%84%E8%AE%BA)** 的開源貢獻與原始核心架構，本腳本為其衍生分支版本，專注於現代模組化架構重構、SPA 穩定性提升與原生 UI（如大航海漸層卡片、排版切齊）的深度還原修復
- Dependencies：  
